...
- 发布候选：取消退出保护（#398 / #402）、原生字体保留（#399 / #403）、首页圆角（#394 / #396，感谢 @chenzhaoxuan0 与实测者 @GreenLv）、更新限流回退（#401，感谢 @guoqunabc），以及此前未发布的 watcher 退避与更新版本来源修复（#387）。完整说明见 [v1.5.17 发布说明](../docs/releases/v1.5.17.md)。
